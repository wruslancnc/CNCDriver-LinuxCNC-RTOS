...
switch (pressed_key) {
	...
	case 114 :    
        ...
        // DRIVE CNC ALONG X-AXIS
        DTStamp();printf(" r drive_right   (500) X-axis (3,2 CW)\t==> (1/0)(1) (0)(0) (0)(0) running ... ");
        fflush(stdout);
	...
	case 108 :    
        ...
        // DRIVE CNC ALONG X-AXIS
        DTStamp(); printf(" l drive_left    (500) X-axis (1,0 CCW)\t==> (1)(0) (0)(0) (0)(0)   running ... ");
        fflush(stdout);
	...
	case 102 :    
	    ...
	    DTStamp();printf(" f drive_forward (500) Y-axis (12,8 CW)\t==> (0)(0) (1/0)(1) (0)(0) running ... ");
	    fflush(stdout);
	...
	case 98 :    
        ...
        DTStamp();printf(" b drive_backward(500) Y-axis (4,0 CCW)\t==> (0)(0) (1)(0) (0)(0)   running ... ");
	    fflush(stdout);
	...
	case 117 :    
        ...
        // DRIVE CNC ALONG Z-AXIS
        DTStamp();printf(" u drive_up      (500) Z-axis (16,0 CW)\t==> (0)(0) (0)(0) (1)(0)   running ... ");
        fflush(stdout);
	 ...
	 case 100 :    
        ...
        // DRIVE CNC ALONG Z-AXIS
        DTStamp();printf(" d drive_down    (500) Z-axis (48,32 CCW)=> (0)(0) (0)(0) (1/0)(1) running ... ");
        fflush(stdout);
        ...
        DTStamp();printf(" q Quit and exit. \t\t==> Alhamdulillah. Done. \n\n");
     ...
     default :
        DTStamp();printf(" %c \tERROR: Invalid command: ==> char %c or int %d \n", pressed_key, pressed_key, pressed_key);
...
wruslan@HPElBk8570w-rtwork1:~/WOM-WRY-UMP-PhD/2023-05-18-parallel-port/jogging-C-code$ gcc -o keyboard-jogging-code.cx keyboard-jogging-code.c
wruslan@HPElBk8570w-rtwork1:~/WOM-WRY-UMP-PhD/2023-05-18-parallel-port/jogging-C-code$ sudo ./keyboard-jogging-code.cx 
2023-05-19 07:04:25.000331073 	Bismillah. Start CNC keyboard jogging. 
2023-05-19 07:04:25.000331123 	Note: You must run with root permission. 

2023-05-19 07:04:25.000331143 	SUCCESS: Set max priority level io_prio_lvl value 	= 0
2023-05-19 07:04:25.000331178 	SUCCESS: Set port i/o permissions io_perm value 	= 0

2023-05-19 07:04:25.000375664 	EXECUTING  open_parallel_port(void).
2023-05-19 07:04:25.000375695 	SUCCESS: Open PARPORT_DEVICE (/dev/lp0).
2023-05-19 07:04:25.000375706 	SUCCESS: Display file descriptor parport_fd 	= 3 
2023-05-19 07:04:25.000375718 	SUCCESS: Display PARPORT_IRQ = 5
2023-05-19 07:04:25.000375728 	SUCCESS: Display BASE_ADDRESS 	= 0x378
2023-05-19 07:04:25.000375739 	SUCCESS: Display CPUMAP 	= 0x08
2023-05-19 07:04:25.000375750 	SUCCESS: Display PERIOD 	= 500000 (ns)
2023-05-19 07:04:25.000375761 	SUCCESS: Display TICK_TIME 	= 1000000 (ns)
2023-05-19 07:04:25.000375770 	COMPLETED open_parallel_port(void).
...
2023-05-19 07:04:28.000566641 	 r drive_right   (500) X-axis (3,2 CW)	==> (1/0)(1) (0)(0) (0)(0) running ... done.
2023-05-19 07:04:30.000033926 	 l drive_left    (500) X-axis (1,0 CCW)	==> (1)(0) (0)(0) (0)(0)   running ... done.
2023-05-19 07:04:34.000745700 	 f drive_forward (500) Y-axis (12,8 CW)	==> (0)(0) (1/0)(1) (0)(0) running ... done.
2023-05-19 07:04:35.000926734 	 b drive_backward(500) Y-axis (4,0 CCW)	==> (0)(0) (1)(0) (0)(0)   running ... done.
2023-05-19 07:04:37.000685725 	 u drive_up      (500) Z-axis (16,0 CW)	==> (0)(0) (0)(0) (1)(0)   running ... done.
2023-05-19 07:04:39.000316870 	 d drive_down    (500) Z-axis (48,32 CCW)=> (0)(0) (0)(0) (1/0)(1) running ... done.
2023-05-19 07:04:47.000480064 	 w 	ERROR: Invalid command: ==> char w or int 119 
2023-05-19 07:04:58.000077765 	 w 	ERROR: Invalid command: ==> char w or int 119 
2023-05-19 07:04:59.000496123 	 d drive_down    (500) Z-axis (48,32 CCW)=> (0)(0) (0)(0) (1/0)(1) running ... done.
2023-05-19 07:05:01.000176386 	 g 	ERROR: Invalid command: ==> char g or int 103 
2023-05-19 07:05:01.000974933 	 h 	ERROR: Invalid command: ==> char h or int 104 
2023-05-19 07:05:03.000682274 	 1 	ERROR: Invalid command: ==> char 1 or int 49 
2023-05-19 07:05:04.000962333 	 2 	ERROR: Invalid command: ==> char 2 or int 50 
2023-05-19 07:05:06.000094901 	 r drive_right   (500) X-axis (3,2 CW)	==> (1/0)(1) (0)(0) (0)(0) running ... done.
2023-05-19 07:05:07.000255926 	 c 	ERROR: Invalid command: ==> char c or int 99 
2023-05-19 07:05:10.000798371 	 r drive_right   (500) X-axis (3,2 CW)	==> (1/0)(1) (0)(0) (0)(0) running ... done.
2023-05-19 07:05:11.000960398 	 l drive_left    (500) X-axis (1,0 CCW)	==> (1)(0) (0)(0) (0)(0)   running ... done.
2023-05-19 07:05:13.000265492 	 f drive_forward (500) Y-axis (12,8 CW)	==> (0)(0) (1/0)(1) (0)(0) running ... done.
2023-05-19 07:05:16.000087293 	 b drive_backward(500) Y-axis (4,0 CCW)	==> (0)(0) (1)(0) (0)(0)   running ... done.
2023-05-19 07:05:22.000646173 	 q Quit and exit. 		==> Alhamdulillah. Done. 

2023-05-19 07:05:22.000652065 	EXECUTING close_parallel_port(void).
2023-05-19 07:05:22.000652106 	SUCCESS: Close PARALLEL_PORT (/dev/lp0).
2023-05-19 07:05:22.000652119 	SUCCESS: Display close_parport value 	= 0
2023-05-19 07:05:22.000652133 	COMPLETED close_parallel_port(void).

2023-05-19 07:05:22.000652147 	EXECUTING close_keyboard(void).
2023-05-19 07:05:22.000652166 	SUCCESS: Display close_keyboard_value 	= 0
2023-05-19 07:05:22.000652179 	COMPLETED close_keyboard(void).
2023-05-19 07:05:22.000652192 	Alhamdulillah. Finished CNC keyboard jogging. 

wruslan@HPElBk8570w-rtwork1:~/WOM-WRY-UMP-PhD/2023-05-18-parallel-port/jogging-C-code$ 
*/
// ==================================================================
